...
![bache.jpeg](/images/2018-10-21-Analisis-Twitter-MuniAsu/bache.jpeg)
*([Fuente](http://www.lavozdigital.com.py/noticia.php?id=10658&id_categoria=9))*
...
![Nube de Palabras](/images/2018-10-21-Analisis-Twitter-MuniAsu/word_cloud_2.png)
...
Para cada categoría se define una lista de palabras relacionadas utilizando [expresiones regulares](https://platzi.com/blog/expresiones-regulares-python/) para identificar patrones. Por ejemplo, en el caso de basura se incluye _basura*, vertedero*, recicla*, desecho*, tóxico*, escombro*_. Los asteriscos indican que luego de la palabra pueden seguir 0 o más caracteres (ej. **recicla**do, **recicla**je, **recicla**mos). 
...
![Temas Criticos por Dia](/images/2018-10-21-Analisis-Twitter-MuniAsu/historico_menciones_new.png)
...
En este análisis se utiliza un modelo desarrollado por [Elliot Hofman](https://github.com/aylliote/senti-py) que asigna _scores_ de sentimiento a los textos de acuerdo al contenido. 

![Historico de Sentimiento de Tweets](/images/2018-10-21-Analisis-Twitter-MuniAsu/historico_sentimiento.png)
...
Esto puede indicar que las publicaciones que hablan de dengue, también mencionan en muchos casos a la basura. Podemos validar esta hipótesis con una gráfica denominada [Scatter Text](https://github.com/JasonKessler/scattertext). 

![scatter_text_new.png](/images/2018-10-21-Analisis-Twitter-MuniAsu/scatter_text_new.png)
