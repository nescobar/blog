...
The Jupyter Notebook with the full analysis can be accessed [here](https://github.com/nescobar/data-analysis/blob/master/atp_tennis_analytics_refactored.ipynb).
...
We start the EDA by looking at the distribution of some of the key attributes. [Histograms](https://en.wikipedia.org/wiki/Histogram) are very helpful to represent numerical distributions of the underlying data. 
...
```
![Histograms](/images/2018-10-7-Tennis-Visualization/1_histograms.png "Histograms of key variables")
...
![Scatter Plot](/images/2018-10-7-Tennis-Visualization/2_scatter_plot.png "Scatter plot of Winners' Rankings")
...
![Box Plot](/images/2018-10-7-Tennis-Visualization/3_box_plot_surface.png "Box plot of aces by surface type")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/4_plots_countries.png "Evolution of specific countries based on their players wins")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/5_most_aces_barplot.png "Players with Most Aces")

![Plots](/images/2018-10-7-Tennis-Visualization/6_most_df_barplot.png "Players with Most Double Falts")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/7_roger_federer_evolution.png "Roger Federer's wins over time")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/7_rafael_nadal_evolution.png "Rafael Nadal's wins over time")
...
![Plots](/images/2018-10-7-Tennis-Visualization/8_unique_players_gs_evolution.png "Unique # of Players that Won GS and Masters Finals")
...
![Plots](/images/2018-10-7-Tennis-Visualization/9_unique_players_gs_ranges.png "Unique # of Players that Won GS Finals")
...
![Plots](/images/2018-10-7-Tennis-Visualization/10_roger_federer_effectiveness.png "Roger Federer's effectiveness by surface type")
...
![Plots](/images/2018-10-7-Tennis-Visualization/11_rafael_nadal_effectiveness.png "Rafael Nadal's effectiveness by surface type")
...
![Plots](/images/2018-10-7-Tennis-Visualization/12_age_grandslams.png "Age of Grand Slam champions from 1968")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/13_retirements_evolution.png "Retirements by surface type")
...
![Plots](/images/2018-10-7-Tennis-Visualization/14_retirements_surface.png "Retirements by surface type (log)")
...
```
![Plots](/images/2018-10-7-Tennis-Visualization/15_top_rivalries.png "Top rivalries in tennis history")
